...
The Lib\_VTK\_IO is an open source project, it is distribuited under the [GPL v3](http://www.gnu.org/licenses/gpl-3.0.html). Anyone is interest to use, to develop or to contribuite to Lib\_VTK\_IO is welcome.
