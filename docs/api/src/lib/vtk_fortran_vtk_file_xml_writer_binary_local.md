---
title: vtk_fortran_vtk_file_xml_writer_binary_local
---
...
```mermaid
graph LR
  vtk_fortran_vtk_file_xml_writer_binary_local["vtk_fortran_vtk_file_xml_writer_binary_local"] --> vtk_fortran_dataarray_encoder["vtk_fortran_dataarray_encoder"]
  vtk_fortran_vtk_file_xml_writer_binary_local["vtk_fortran_vtk_file_xml_writer_binary_local"] --> vtk_fortran_vtk_file_xml_writer_abstract["vtk_fortran_vtk_file_xml_writer_abstract"]
```

## Contents

- [xml_writer_binary_local](#xml-writer-binary-local)
...
|------|------|--------|------------|-------------|
| `self` | class([xml_writer_binary_local](/api/src/lib/vtk_fortran_vtk_file_xml_writer_binary_local#xml-writer-binary-local)) | inout |  | Writer. |
...
|------|------|--------|------------|-------------|
| `self` | class([xml_writer_binary_local](/api/src/lib/vtk_fortran_vtk_file_xml_writer_binary_local#xml-writer-binary-local)) | inout |  | Writer. |
| `format` | character(len=*) | in |  | File format: binary. |
...
```mermaid
flowchart TD
  write_dataarray1_rank1_R8P["write_dataarray1_rank1_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank1_R4P["write_dataarray1_rank1_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank1_I8P["write_dataarray1_rank1_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank1_I4P["write_dataarray1_rank1_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank1_I2P["write_dataarray1_rank1_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank1_I1P["write_dataarray1_rank1_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_R8P["write_dataarray1_rank2_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_R4P["write_dataarray1_rank2_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_I8P["write_dataarray1_rank2_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_I4P["write_dataarray1_rank2_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_I2P["write_dataarray1_rank2_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank2_I1P["write_dataarray1_rank2_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_R8P["write_dataarray1_rank3_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_R4P["write_dataarray1_rank3_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_I8P["write_dataarray1_rank3_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_I4P["write_dataarray1_rank3_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_I2P["write_dataarray1_rank3_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank3_I1P["write_dataarray1_rank3_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_R8P["write_dataarray1_rank4_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_R4P["write_dataarray1_rank4_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_I8P["write_dataarray1_rank4_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_I4P["write_dataarray1_rank4_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_I2P["write_dataarray1_rank4_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray1_rank4_I1P["write_dataarray1_rank4_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_R8P["write_dataarray3_rank1_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_R4P["write_dataarray3_rank1_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_I8P["write_dataarray3_rank1_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_I4P["write_dataarray3_rank1_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_I2P["write_dataarray3_rank1_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank1_I1P["write_dataarray3_rank1_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_R8P["write_dataarray3_rank3_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_R4P["write_dataarray3_rank3_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_I8P["write_dataarray3_rank3_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_I4P["write_dataarray3_rank3_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_I2P["write_dataarray3_rank3_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray3_rank3_I1P["write_dataarray3_rank3_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_R8P["write_dataarray6_rank1_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_R4P["write_dataarray6_rank1_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_I8P["write_dataarray6_rank1_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_I4P["write_dataarray6_rank1_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_I2P["write_dataarray6_rank1_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank1_I1P["write_dataarray6_rank1_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_R8P["write_dataarray6_rank3_R8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_R4P["write_dataarray6_rank3_R4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_I8P["write_dataarray6_rank3_I8P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_I4P["write_dataarray6_rank3_I4P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_I2P["write_dataarray6_rank3_I2P"] --> encode_binary_dataarray["encode_binary_dataarray"]
...
```mermaid
flowchart TD
  write_dataarray6_rank3_I1P["write_dataarray6_rank3_I1P"] --> encode_binary_dataarray["encode_binary_dataarray"]
