...
module vtk_fortran_vtk_file_xml_writer_binary_local_volatile
!< VTK file XMl writer, binary local, volatile.
...
implicit none
private
public :: xml_writer_binary_local_volatile

type, extends(xml_writer_abstract) :: xml_writer_binary_local_volatile
...
endtype xml_writer_binary_local_volatile
contains
...
endmodule vtk_fortran_vtk_file_xml_writer_binary_local_volatile
